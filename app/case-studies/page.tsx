...
const caseStudies = [
  {
    ...
    solution: "Custom GPT-4 powered onboarding assistant with intelligent form filling and document processing",
    results: [
  ...
  },
  {
    ...
    solution: "Intelligent automation system with real-time data processing and AI-generated insights",
    results: ["30+ hours saved monthly", "95% accuracy improvement", "Real-time insights delivery"],
    image: "/placeholder.svg?height=300&width=400",
  ...
  },
  {
    ...
    solution: "Multi-model LLM platform with content optimization and A/B testing capabilities",
    results: ["300% content output increase", "40% engagement improvement", "60% cost reduction"],
    image: "/placeholder.svg?height=300&width=400",
    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="py-20 gradient-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Real results from real clients. See how we've transformed businesses with AI-powered solutions.
          </motion.p>
        </div>
      </section>
            ...
            {caseStudies.map((study, index) => (
              ...
              >
                <div className={index % 2 === 1 ? "lg:col-start-2" : ""}>
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">{study.title}</h2>
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Let's discuss how we can build a custom AI solution for your specific needs.
          </motion.p>
          <motion.button
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
