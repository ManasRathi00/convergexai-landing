...
const timeline = [
  { year: "2021", event: "Founded Convergex AI with a vision to democratize AI" },
    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="py-20 gradient-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            We're a team of elite full-stack developers on a mission to make AI accessible and practical for every
            business.
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6">
                Convergex AI was born from a simple observation: while AI technology was advancing rapidly, most
                businesses struggled to implement it effectively. We saw companies spending months trying to integrate
                AI solutions that didn't fit their specific needs.
              </p>
              <p className="text-lg text-gray-600 mb-6">
                Our founders, with backgrounds from Google AI and top tech companies, decided to bridge this gap. We
                combine deep AI expertise with practical full-stack development skills to build solutions that actually
                work in the real world.
              </p>
              <p className="text-lg text-gray-600">
                Today, we've helped over 50 companies transform their operations with custom AI solutions, from
                automating complex workflows to building intelligent SaaS products that scale.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 30 }}
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Key milestones in our mission to democratize AI</p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600">The experts behind your AI transformation</p>
          </motion.div>
