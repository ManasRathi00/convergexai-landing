...
export const metadata: Metadata = {
  ...
  keywords: "AI SaaS, automation, LLM integration, full-stack development, AI tools",
  openGraph: {
    title: "Convergex AI - Build Smart. Scale Fast. With AI.",
    description: "Custom-built AI SaaS products and automations by elite full-stack developers.",
    type: "website",
  },
    generator: 'v0.dev'
}
